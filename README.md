...
2. **Submit a New Issue**  
   ...
   - Choose a template:  
     ...
     - **General Support**: For questions about app usage.  
   - Fill in the required details (e.g., device model, iOS/Android version, app version) to help us resolve your issue quickly.

3. **Response Time**  
   We aim to reply to all issues within **24-48 hours** (Monday-Friday). For urgent matters, you can also reach us at smart0806@163.com.


## What We Need from You

To assist efficiently, please include:  
- A clear description of the problem or question.  
- Screenshots/videos (if applicable).  
- Device info (e.g., "iPhone 15, iOS 17.1" or "Samsung Galaxy S23, Android 14").  
- App version (found in the app’s Settings > About).  
